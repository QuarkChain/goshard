...
// Adaptation: the forked goquarkchain core/state -> geth core/state in the
// Finalize signature (the execution issue will operate on geth state).
...
type Engine interface {
	...
	CalcDifficulty(chain ChainReader, time uint64, parent types.IBlock) (*big.Int, error)
