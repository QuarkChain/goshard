...
func (storageTestProcessor) Process(*types.MinorBlock, *state.StateDB, XShardDepositCursor, vm.Config) (*ProcessResult, error) {
...
func TestNewMinorBlockChainInitializesGenesisHead(t *testing.T) {
	...
	chain, err := NewMinorBlockChain(db, storageTestShardConfig(), storageTestProcessor{}, NewBasicMinorBlockValidator(), vm.Config{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestNewMinorBlockChainRejectsUnavailableHead(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			_, err := NewMinorBlockChain(db, storageTestShardConfig(), storageTestProcessor{}, NewBasicMinorBlockValidator(), vm.Config{})
