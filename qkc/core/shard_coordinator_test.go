...
func (s *minorChainStub) InsertBlockWithXShardInput(block *types.MinorBlock, cursor *XShardTxCursor, options InsertOptions) ([]*types.CrossShardTransactionDeposit, error) {
	s.insertions++
	s.options = options
	if s.insertErr != nil {
